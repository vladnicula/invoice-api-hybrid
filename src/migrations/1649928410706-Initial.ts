...
export class Initial1649928410706 implements MigrationInterface {
    name = 'Initial1649928410706'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "invoice_item_entity" ("id" varchar PRIMARY KEY NOT NULL, "description" varchar NOT NULL, "price" float NOT NULL, "invoiceId" varchar NOT NULL, "userId" varchar NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_invoice_item_entity" ("id" varchar PRIMARY KEY NOT NULL, "description" varchar NOT NULL, "price" float NOT NULL, "invoiceId" varchar NOT NULL, "userId" varchar NOT NULL, CONSTRAINT "FK_440807a24ba1f079be090d2ed80" FOREIGN KEY ("invoiceId") REFERENCES "invoice_entity" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_ef281599cbfec8cfdb1a0fe2164" FOREIGN KEY ("userId") REFERENCES "user_entity" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_invoice_item_entity"("id", "description", "price", "invoiceId", "userId") SELECT "id", "description", "price", "invoiceId", "userId" FROM "invoice_item_entity"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "invoice_item_entity" ("id" varchar PRIMARY KEY NOT NULL, "description" varchar NOT NULL, "price" float NOT NULL, "invoiceId" varchar NOT NULL, "userId" varchar NOT NULL)`);
        await queryRunner.query(`INSERT INTO "invoice_item_entity"("id", "description", "price", "invoiceId", "userId") SELECT "id", "description", "price", "invoiceId", "userId" FROM "temporary_invoice_item_entity"`);
