...
import { CreateInvoiceDTO, CreateInvoiceItemsDTO } from 'src/invoices/dto/create-invoice.dto';
...
export class InvoiceAppSeederService {
    ...
    private async createClient (userId: string) {
        const createdClient = await this.clientsService.create(userId, new CreateClientDTO({
