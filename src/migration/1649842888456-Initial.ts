...
export class Initial1649842888456 implements MigrationInterface {
    name = 'Initial1649842888456'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_invoice_entity" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "date" varchar NOT NULL, "dueDate" varchar NOT NULL, "items" varchar NOT NULL, "total" varchar NOT NULL, "userId" integer, "clientId" integer, CONSTRAINT "FK_421ca52ae746d23e37b3f49a432" FOREIGN KEY ("userId") REFERENCES "user_entity" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_5bd48b8ec417b31da9e9d0d7211" FOREIGN KEY ("clientId") REFERENCES "client_entity" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
